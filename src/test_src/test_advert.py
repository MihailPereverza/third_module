...
def correct_inheritance_json_advert():
    ...
    assert lesson_dict['location'].__dict__['address'] == 'город Москва, Лесная, 7'
    assert lesson_dict['location'].__dict__['metro_stations'] == ['Белорусская']
